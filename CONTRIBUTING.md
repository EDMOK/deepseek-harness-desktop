...
DeepSeek Harness is a developer preview. Public APIs, package layouts, profiles, and local data formats may change without a compatibility guarantee. Read [`AGENTS.md`](AGENTS.md) before changing packages.
